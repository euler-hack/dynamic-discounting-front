...
<div class="activelist">
  ...
  <ExecuteAuction v-bind:auction_id="current" v-if="current" />
</div>
</template>
...
import ExecuteAuction from "@/components/ExecuteAuction.vue"
...
mounted () {
    let self = this
    this.contract.getMyOpenAuctions(function(err, res) {self.updateList(res)})
},
methods: {
